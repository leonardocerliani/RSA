...
# Here we test that the maximum emotion rating across six emotion is consistent 
# with the actually displayed emotion in the video.
# In the end we will have the percentage of movies that were correctly rated as that
# emotion
rune_df %>%
