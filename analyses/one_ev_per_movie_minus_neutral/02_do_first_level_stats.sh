...
contrast_lines_filename="contrast_lines.txt"
...
# are NOT indented 
# NB: the following lines have been removed as they will be added
# by the contrast_lines.txt
...
# Add the contrast_lines at the end of the fsf file
{ echo; echo; echo; } >> ${fsf_sub_run}
echo "# Contrast lines below" >> ${fsf_sub_run}
cat ${contrast_lines_filename} >> ${fsf_sub_run}

done
# end of the main loop over runs
