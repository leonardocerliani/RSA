...
# Calculate RSA : Regular version, with no regressing out the other two rdm_[behaviour]
```{r}
# ---------------------------------------------------------------
...
# Calculate RSA resid : After partial regression of the other two rdm_[behaviour]
```{r}
# ---------------------------------------------------------------
...
# Save results in RSA_ROI_APP OLE
```{r}
...
#   
#   results_filename <- paste0(atlas_root, EV_abbr, option_MN, option_NN, nsubs, "___V15")
...
# Save results in RSA_ROI_APP NEW
```{r}
