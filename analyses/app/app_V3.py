...
from copes_dictionaries import dict_emotion, dict_muviz
...
with main_col:
    ...
    if selected_model in dizio and 'grouplevel' in dizio[selected_model]:
        ...
        if selected_model and selected_cope:

            if selected_model == 'emotion':
                display_cope_name = dict_emotion[selected_cope]
            elif selected_model == 'one_ev_per_movie':
                display_cope_name = dict_muviz[selected_cope] 
            else: 
                display_cope_name = selected_cope

            # Display the group-level result
            st.subheader(f"Grouplevel result for {selected_model}, {display_cope_name}")
