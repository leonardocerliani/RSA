...
# # To run all atlases:
# ./do_RSA_ROI_V2.sh Yeo7.nii.gz YES NO N26 &
# ./do_RSA_ROI_V2.sh Yeo17.nii.gz YES NO N26 &
# ./do_RSA_ROI_V2.sh HO_cort.nii.gz YES NO N26 &
# ./do_RSA_ROI_V2.sh anatomy_toolbox_for_RSA.nii.gz YES NO N26 &
# wait
# echo "All RSA scripts have finished!"


# Define the root directory
root=/data00/leonardo/RSA/analyses

# Which version of the RSA calculation script should I use?
RSA_version="V14"

# Print out which RSA calculation version we are using
echo
