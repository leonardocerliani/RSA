    ...
    mainPanel(width = 9,
              fluidRow(
                column(4,
                       ...
                       tags$h4("ROIs from Atlas"), papayaOutput("selected_ROI"),
...
server <- function(input, output, session) {
  ...
  observe({
    ...
    # show the selected ROI in papaya
    output$selected_ROI <- renderPapaya({
...
# Prepare tmp_ROI.nii.gz to display in papaya as selected from the RSA_mean table
