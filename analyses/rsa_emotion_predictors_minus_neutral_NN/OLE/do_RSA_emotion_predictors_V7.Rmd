...
source("funs_emotion_predictors_V7.R")
...
atlas_filename <-  "insula_HO_voxels.nii.gz"
# choices:
# HO_cort_2mm.nii.gz
# HO_sub_2mm.nii.gz
# juelich_2mm.nii.gz
...
# Calculate RATINGS RDMs - IMPORTANT DIFFERENCE FOR EMOTION PREDICTORS MODEL
...
all_similarities <- joint_fmri_rat_nested %>% 
  mutate(similarity = list(fmri,rat) %>% pmap_dbl(~ cor(.x,.y, method = "pearson")) ) %>%
  ungroup
