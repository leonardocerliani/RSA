...
papaya_layout <- function(directory, subs_set) {
  papaya(
    ...
    options = list(
      ...
      papayaOptions(alpha = 1, lut = "Red Overlay", min = thr, max = 0.1),
      papayaOptions(alpha = 1, lut = "Blue Overlay", min = thr, max = 0.1),
      papayaOptions(alpha = 1, lut = "Green Overlay", min = thr, max = 0.1),
...
do_ROI_from_center <- function(x,y,z,radius,MNI) {
