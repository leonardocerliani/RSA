...
do_boxplot <- function(bd, directory, subs_set) {
  ...
  get_avg_ROI_values <- function(rat_type, bd, directory, subs_set, subs) {
    ...
    root <- file.path(bd, directory, paste0(subs_set,"_insula_HO_GM_EER"))
...
papaya_layout <- function(directory, subs_set) {
  papaya(
    c(
      ...
      file.path(bd, directory, paste0(subs_set,"_insula_HO_GM_EER_arousal.nii.gz")),
      file.path(bd, directory, paste0(subs_set,"_insula_HO_GM_EER_emotion.nii.gz")),
      file.path(bd, directory, paste0(subs_set,"_insula_HO_GM_EER_valence.nii.gz")),
      "ROI.nii.gz"
    ),
    options = list(
