...
export model="emotion_predictors_minus_neutral"
...
# There are 7 copes in the emotion_predictors model:
# 1. anger
# 2. disgust
# 3. fear
# 4. happy
...
fsf_grouplevel_template="${analyses_dir}/grouplevel_template_modified_for_emotion_predictors.fsf"
...
# run all the grouplevel copes (7 for emotion_predictors) at once
