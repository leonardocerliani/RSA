...
# launch with :
# nohup ./00_launch_whole_analysis.sh > nohup_emotion_predictors_minus_neutral.out &

model="emotion_predictors"
...
# ./03_do_higher_levels_modified_for_emotion_predictors.sh
