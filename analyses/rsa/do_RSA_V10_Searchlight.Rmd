...
# copes_location_csv <- paste0(bd,"/rsa/copes_location.csv") # OLE VERSION
...
# NB: the column headers represent the index (idx) of voxels inside the mask
...
# again the 'region' numbers represent the index (idx) of a given voxel
# in the used brain mask
avg_RSA %>% datatable()
```
