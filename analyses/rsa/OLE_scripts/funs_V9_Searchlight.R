...
generate_results_flavour <- function(gm_file, dist_method_rating, dist_method_fmri, dist_method_rsa) {
...
write_RSA_results_to_nii <- function(df_RSA, ratings_type, results_dir, gm) {
  ...
  sub_ID <- df_RSA$sub[1]
  nii2write_path <- paste0(results_dir,"/", "sub_", sub_ID,"_RSA_",ratings_type,".nii.gz")
