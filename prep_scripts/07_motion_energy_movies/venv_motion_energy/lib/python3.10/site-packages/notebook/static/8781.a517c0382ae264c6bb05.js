...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(87776);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(91346),
    __webpack_require__(26718),
    __webpack_require__(43446),
    __webpack_require__(74553),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(28369),
  __webpack_require__(48662),
  __webpack_require__(3838),
  __webpack_require__(56999),
  __webpack_require__(94971),
  __webpack_require__(26678),
  __webpack_require__(22294),
  
      (__webpack_require__(24606)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(39689)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      (__webpack_require__(78325)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(2262)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(89816),
  
      (__webpack_require__(50658)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(9419)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(85705)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(44821)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(29275)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(10950),
  __webpack_require__(71875),
  __webpack_require__(84640),
  
      (__webpack_require__(84999)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(37674),
  __webpack_require__(31827),
  __webpack_require__(68833),
  
      (__webpack_require__(70686)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
  ...
  __webpack_require__(29939),
  __webpack_require__(2860),
  __webpack_require__(74532),
  __webpack_require__(84657),
  __webpack_require__(65968),
  __webpack_require__(17248),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(82753),
  
      (__webpack_require__(50468)["default"].filter)(({id}) => [
  ...
  __webpack_require__(19337),
  
      (__webpack_require__(31049)["default"].filter)(({id}) => [
...
'@jupyterlab/debugger-extension:sources',
      ...
      __webpack_require__(23798),
  __webpack_require__(43758),
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(25427)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(22300)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(78376).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(5683).IServiceManager);
...
//# sourceMappingURL=8781.a517c0382ae264c6bb05.js.map?v=a517c0382ae264c6bb05